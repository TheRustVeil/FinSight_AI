...
export default function LoginPage() {
  ...
  return (
    <>
      ...
      <p className="text-muted-foreground text-sm mb-6">Sign in to your FinSight account</p>
      ...
      <form onSubmit={handleSubmit((d) => login(d))} className="space-y-4">
        ...
        <div>
          <div className="flex justify-between items-center mb-1.5">
            ...
            <Link href="/forgot-password" className="text-primary text-xs hover:text-primary/80">Forgot password?</Link>
          </div>
          <div className="relative">
        ...
        <a
          ...
          className="w-full flex items-center justify-center gap-3 bg-background hover:bg-muted border border-input rounded-lg py-2.5 text-foreground text-sm font-medium transition-colors"
        >
      ...
      <p className="text-center text-muted-foreground text-sm mt-6">
        ...
        <Link href="/register" className="text-primary hover:text-primary/80 font-medium">Create one</Link>
      </p>
    </>
  );
}
